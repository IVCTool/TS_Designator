...
import nl.tno.msg.tc_lib_designator.DesignatorBaseModel.TC;
 ...
 * @author Rein (TNO MSG)
 */
public class TC0002_Deadreckoning extends TC_BaseClass {
	@Override
	protected void logTestPurpose(final Logger logger) {
		...
		stringBuilder.append("Designator dead reckoning\n");
